...
public:
    ...
    bool flag_CloseRun;
    bool flag_USB_Rejime;
    bool flag_LastRun;
    bool flag_ChangeExpoBeforeRun;
    ...
    */
    ...
    QVector<quint16> Expozition_Def;    // default (factory) expositions
    QVector<double>  Expozition_Coeff;  // expo coefficients from test
    int Count_Tubes;
    int Tube_Height;
    ...
    QMap<QString,QString> map_InfoUSB;
    ...
    bool Create_MeasureProtocol(QString text = "", bool last_run = false); // create Measure protocol (RUN + Measure)
    ...
    QString Property_WebProtocol(rt_Protocol*);     // output value (QString) = id_protocol in properties of Protocol
    bool IsExpositionEqual(QVector<quint16>&);                       // check expozitions before run
...
public slots:
    ...
    void slot_CheckExpozition_BeforeRun();
    void slot_Run();
    void slot_Stop();
    void slot_Pause();
    void slot_LastRun();
...
signals:
    ...
    void sSaveProtocolToServer();

    void sRun_Start();
    void sRun_Stop();
    void sPause_rejime(int);
    void sRun_Process(int, QString);
    void sRun_rejime(bool);
    ...
    void sLoad_USB_Protocol();

    void sLoad_LastRunProtocol();
